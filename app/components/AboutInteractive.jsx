  ...
  return (
    <>
      ...
      <div className={styles.kineticBackground}>
        <div
          className={`${styles.floatingElement} ${styles.floatingTriangle}`}
        ></div>
        <div
          className={`${styles.floatingElement} ${styles.floatingCircle}`}
        ></div>
        <div
          className={`${styles.floatingElement} ${styles.floatingSquare}`}
        ></div>
      </div>
    </>
  );
